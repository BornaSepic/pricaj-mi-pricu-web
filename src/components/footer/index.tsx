...
export const Footer = () => {
    ...
    return (
        <>
            <div className={`${styles.slideUpMenu} ${isClosing ? styles.menuClosing : ''} ${menuOpen ? styles.menuOpen : ''}`}>
            ...
            <footer className={styles.footer}>
                <div className={`${styles.logoContainer} ${menuOpen && !isClosing ? styles.active : ''}`} onClick={toggleMenu}>
